            ...
            <ul class="stats-tabs">
                <li>
                    <?php
                        ...
                        $sql = "SELECT COUNT(present) AS 'missedHours', course.name AS cid
                                FROM attendance, class, course
                                WHERE attendance.present = 0 AND attendance.student =$LOGGED_USER AND class.course = course.id AND attendance.class = class.id
                                GROUP BY course;";
